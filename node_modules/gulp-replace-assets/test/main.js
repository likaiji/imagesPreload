...
describe('gulp-replace-assets', function() {
  describe('replacePlugin()', function() {
    it('should replace string with string on a stream (1)', function(done) {
      ...
      stream.on('data', function(newFile) {
        ...
        newFile.contents.pipe(es.wait(function(err, data) {
		  ...
		  data.equals(fs.readFileSync('test/expected/helloworld.txt')).should.be.true
          done();
        }));
      });
    ...
    it('should replace string with string on a buffer (3)', function(done) {
      var file = new gutil.File({
        path: 'test/fixtures/helloworld.txt',
        cwd: 'test/',
        base: 'test/fixtures',
